...
public class config {
    ...
    public static final int APPEL_PRICE = 10;
    public static final int BANAAN_PRICE = 12;
    public static final int MANGO_PRICE = 20;
    public static final int AVOCADO_PRICE = 30;
    public static final int CITROEN_PRICE = 11;
    public static final int PEER_PRICE = 9;
    public static final int KERS_PRICE = 15;
    public static final int DRUIF_PRICE = 13;
    public static final int ANANAS_PRICE = 25;
    public static final int SPACEWEED_PRICE = 69;
    ...
    // 📦 Opslag instellingen
    public static final int START_STORAGE = 10;
    public static final int STORAGE_UPGRADE_PRICE = 300;
